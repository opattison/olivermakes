...
<img src="{{ page.image[1].src | imgix_url: w: 720, q: 50 }}" alt="{{ page.image[1].alt }}">
...
<figure class="image--half screenshot">
  <img src="{{ page.image[2].src | imgix_url: w: 720, q: 50 }}" alt="{{ page.image[2].alt }}" />
</figure>
...
<figure class="image--narrow screenshot">
  <img src="{{ page.image[3].src | imgix_url: w: 720, q: 50 }}" alt="{{ page.image[3].alt }}" />
  <figcaption>
...
<figure class="image--narrow screenshot">
  <img src="{{ page.image[4].src | imgix_url: w: 720, q: 50 }}" alt="{{ page.image[4].alt }}" />
  <figcaption>
...
<figure class="image--half screenshot">
  <img src="{{ page.image[6].src | imgix_url: w: 720, q: 50 }}" alt="{{ page.image[6].alt }}" />
</figure>
